<script lang="ts">
	...
	function filterRowClass(selected: boolean, extra = ''): string {
		...
		return `filter-option-row grid w-full items-center gap-1.5 px-2.5 py-1 text-left text-[13px] text-[var(--color-surface-text)] transition-colors ${selected ? selectedClasses : unselectedClasses} ${extra}`;
	}

	function countClass(selected: boolean): string {
		return selected
			? 'text-[11px] font-semibold text-[var(--color-primary-200)]'
			: 'text-[11px] text-[var(--color-surface-text-muted)]';
	}
...
>
	...
	<div class="sticky top-0 z-10 border-b border-[var(--color-surface-border)] bg-[var(--color-surface-overlay)]">
		<div class="flex min-h-11 items-center justify-between gap-2 px-3 py-2">
			<div class="flex items-center gap-1.5">
				<h2 class="text-sm font-semibold text-[var(--color-surface-text)]">Filters</h2>
				<button
					type="button"
				...
				>
					...
					<svg class="h-2.5 w-2.5 transition-transform {showSettings ? 'rotate-180' : ''}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			<div class="flex items-center gap-1.5">
				<button
					...
					class="rounded px-1.5 py-0.5 text-[11px] font-semibold text-[var(--color-surface-text-muted)] transition-colors hover:bg-[var(--color-surface-700)] hover:text-[var(--color-surface-text)] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-transparent disabled:hover:text-[var(--color-surface-text-muted)]"
				>
					Clear
				</button>
				<button
					onclick={onClose}
					aria-label="Close filters"
					class="rounded p-0.5 text-[var(--color-surface-text-muted)] transition-colors hover:bg-[var(--color-surface-700)] hover:text-[var(--color-surface-text)]"
				>
		...
		{#if showSettings}
			<div class="space-y-2 border-t border-[var(--color-surface-border)] px-3 pb-3 pt-2">
				<div>
					<div class="mb-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-[var(--color-surface-text-muted)]">Across categories</div>
					<div class="relative grid grid-cols-3 rounded-lg border border-[var(--color-surface-border)] bg-[var(--color-surface-base)] p-0.5">
						...
						{#each FILTER_MODES as mode}
							<button
								...
								class="relative z-10 rounded-md px-1.5 py-1 text-[10px] font-semibold tracking-wide transition-colors {filterMode === mode ? 'text-white' : 'text-[var(--color-surface-text-muted)] hover:text-[var(--color-surface-text)]'}"
							>
								{mode}
							</button>
						{/each}
				...
				<div>
					<div class="mb-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-[var(--color-surface-text-muted)]">Within categories</div>
					<div class="relative grid grid-cols-3 rounded-lg border border-[var(--color-surface-border)] bg-[var(--color-surface-base)] p-0.5">
						<span
							class="absolute bottom-0.5 left-0.5 top-0.5 rounded-md bg-[var(--color-primary-500)] shadow-sm transition-transform duration-200 ease-out"
						...
						{#each FILTER_MODES as mode}
							<button
								...
								class="relative z-10 rounded-md px-1.5 py-1 text-[10px] font-semibold tracking-wide transition-colors {valueFilterMode === mode ? 'text-white' : 'text-[var(--color-surface-text-muted)] hover:text-[var(--color-surface-text)]'}"
							>
								{mode}
							</button>
						{/each}
				...
				<div>
					<div class="mb-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-[var(--color-surface-text-muted)]">Filter sort</div>
					<div class="grid grid-cols-2 rounded-lg border border-[var(--color-surface-border)] bg-[var(--color-surface-base)] p-0.5">
						{#each FILTER_OPTION_SORTS as option}
							<button
								...
								class="rounded-md px-1.5 py-1 text-[11px] font-semibold transition-colors {filterOptionSort === option.value ? 'bg-[var(--color-primary-500)] text-white' : 'text-[var(--color-surface-text-muted)] hover:bg-[var(--color-surface-700)] hover:text-[var(--color-surface-text)]'}"
							>
								{option.label}
							</button>
						{/each}
	...
	<div class="space-y-1.5 p-2.5">
		<section class="rounded-md border border-[var(--color-surface-border)] bg-[var(--color-surface-base)] p-2" aria-labelledby="reading-status-filter-label">
			<div id="reading-status-filter-label" class="mb-1.5 text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--color-surface-text)]">Reading Status</div>
		...
		<div class="overflow-hidden rounded-lg border border-[var(--color-surface-border)]">
			<button onclick={() => authorsOpen = !authorsOpen} class="flex w-full items-center justify-between border-l-4 border-[var(--color-primary-500)]/50 bg-[var(--color-surface-base)] px-2.5 py-1.5 transition-colors hover:bg-[var(--color-surface-700)]">
				<span class="text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--color-surface-text)]">Author</span>
				<div class="flex items-center space-x-2">
					<span class="rounded bg-[var(--color-surface-overlay)] px-1.5 py-0.5 text-[11px] text-[var(--color-surface-text-muted)]">{authors.length}</span>
					<svg class="h-3.5 w-3.5 text-[var(--color-surface-text-muted)] transition-transform {authorsOpen ? 'rotate-180' : ''}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
					</svg>
				</div>
			</button>
			{#if authorsOpen}
				<div class="border-b border-[var(--color-surface-border)] p-1.5">
					<input type="search" bind:value={authorSearch} placeholder="Search authors" class="h-7 w-full rounded-md border border-[var(--color-surface-border)] bg-[var(--color-surface-overlay)] px-2 text-xs text-[var(--color-surface-text)] placeholder:text-[var(--color-surface-text-muted)] focus:border-[var(--color-primary-500)] focus:outline-none" />
				</div>
				<div class="max-h-48 overflow-y-auto">
					...
					{/each}
					{#if authors.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No authors found</p>
					{:else if visibleAuthors.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No matching authors</p>
					{/if}
				</div>
			{/if}
		</div>
		...
		<div class="overflow-hidden rounded-lg border border-[var(--color-surface-border)]">
			<button onclick={() => seriesOpen = !seriesOpen} class="flex w-full items-center justify-between border-l-4 border-[var(--color-primary-500)]/50 bg-[var(--color-surface-base)] px-2.5 py-1.5 transition-colors hover:bg-[var(--color-surface-700)]">
				<span class="text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--color-surface-text)]">Series</span>
				<div class="flex items-center space-x-2">
					<span class="rounded bg-[var(--color-surface-overlay)] px-1.5 py-0.5 text-[11px] text-[var(--color-surface-text-muted)]">{series.length}</span>
					<svg class="h-3.5 w-3.5 text-[var(--color-surface-text-muted)] transition-transform {seriesOpen ? 'rotate-180' : ''}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
					</svg>
				</div>
			</button>
			{#if seriesOpen}
				<div class="border-b border-[var(--color-surface-border)] p-1.5">
					<input type="search" bind:value={seriesSearch} placeholder="Search series" class="h-7 w-full rounded-md border border-[var(--color-surface-border)] bg-[var(--color-surface-overlay)] px-2 text-xs text-[var(--color-surface-text)] placeholder:text-[var(--color-surface-text-muted)] focus:border-[var(--color-primary-500)] focus:outline-none" />
				</div>
				<div class="max-h-48 overflow-y-auto">
					...
					{/each}
					{#if series.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No series found</p>
					{:else if visibleSeries.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No matching series</p>
					{/if}
				</div>
			{/if}
		</div>
		...
		<div class="overflow-hidden rounded-lg border border-[var(--color-surface-border)]">
			<button onclick={() => tagsOpen = !tagsOpen} class="flex w-full items-center justify-between border-l-4 border-[var(--color-primary-500)]/50 bg-[var(--color-surface-base)] px-2.5 py-1.5 transition-colors hover:bg-[var(--color-surface-700)]">
				<span class="text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--color-surface-text)]">Tags</span>
				<div class="flex items-center space-x-2">
					<span class="rounded bg-[var(--color-surface-overlay)] px-1.5 py-0.5 text-[11px] text-[var(--color-surface-text-muted)]">{tags.length}</span>
					<svg class="h-3.5 w-3.5 text-[var(--color-surface-text-muted)] transition-transform {tagsOpen ? 'rotate-180' : ''}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
					</svg>
				</div>
			</button>
			{#if tagsOpen}
				<div class="border-b border-[var(--color-surface-border)] p-1.5">
					<input type="search" bind:value={tagSearch} placeholder="Search tags" class="h-7 w-full rounded-md border border-[var(--color-surface-border)] bg-[var(--color-surface-overlay)] px-2 text-xs text-[var(--color-surface-text)] placeholder:text-[var(--color-surface-text-muted)] focus:border-[var(--color-primary-500)] focus:outline-none" />
				</div>
				<div class="max-h-48 overflow-y-auto">
					...
					{/each}
					{#if tags.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No tags found</p>
					{:else if visibleTags.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No matching tags</p>
					{/if}
				</div>
			{/if}
		</div>
		...
		<div class="overflow-hidden rounded-lg border border-[var(--color-surface-border)]">
			<button onclick={() => formatsOpen = !formatsOpen} class="flex w-full items-center justify-between border-l-4 border-[var(--color-primary-500)]/50 bg-[var(--color-surface-base)] px-2.5 py-1.5 transition-colors hover:bg-[var(--color-surface-700)]">
				<span class="text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--color-surface-text)]">Format</span>
				<div class="flex items-center space-x-2">
					<span class="rounded bg-[var(--color-surface-overlay)] px-1.5 py-0.5 text-[11px] text-[var(--color-surface-text-muted)]">{formats.length}</span>
					<svg class="h-3.5 w-3.5 text-[var(--color-surface-text-muted)] transition-transform {formatsOpen ? 'rotate-180' : ''}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
					</svg>
				</div>
			</button>
			{#if formatsOpen}
				<div class="border-b border-[var(--color-surface-border)] p-1.5">
					<input type="search" bind:value={formatSearch} placeholder="Search formats" class="h-7 w-full rounded-md border border-[var(--color-surface-border)] bg-[var(--color-surface-overlay)] px-2 text-xs text-[var(--color-surface-text)] placeholder:text-[var(--color-surface-text-muted)] focus:border-[var(--color-primary-500)] focus:outline-none" />
				</div>
				<div class="max-h-48 overflow-y-auto">
					...
					{/each}
					{#if formats.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No formats found</p>
					{:else if visibleFormats.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No matching formats</p>
					{/if}
				</div>
			{/if}
		</div>
		...
		<div class="overflow-hidden rounded-lg border border-[var(--color-surface-border)]">
			<button onclick={() => publishersOpen = !publishersOpen} class="flex w-full items-center justify-between border-l-4 border-[var(--color-primary-500)]/50 bg-[var(--color-surface-base)] px-2.5 py-1.5 transition-colors hover:bg-[var(--color-surface-overlay)]">
				<span class="text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--color-surface-text)]">Publisher</span>
				<div class="flex items-center space-x-2">
					<span class="rounded bg-[var(--color-surface-overlay)] px-1.5 py-0.5 text-[11px] text-[var(--color-surface-text-muted)]">{publishers.length}</span>
					<svg class="h-3.5 w-3.5 text-[var(--color-surface-text-muted)] transition-transform {publishersOpen ? 'rotate-180' : ''}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
					</svg>
				</div>
			</button>
			{#if publishersOpen}
				<div class="border-b border-[var(--color-surface-border)] p-1.5">
					<input type="search" bind:value={publisherSearch} placeholder="Search publishers" class="h-7 w-full rounded-md border border-[var(--color-surface-border)] bg-[var(--color-surface-overlay)] px-2 text-xs text-[var(--color-surface-text)] placeholder:text-[var(--color-surface-text-muted)] focus:border-[var(--color-primary-500)] focus:outline-none" />
				</div>
				<div class="max-h-48 overflow-y-auto">
					...
					{#if publishers.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No publishers found</p>
					{:else if visiblePublishers.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No matching publishers</p>
					{/if}
				</div>
			{/if}
		</div>
		...
		<div class="overflow-hidden rounded-lg border border-[var(--color-surface-border)]">
			<button onclick={() => languagesOpen = !languagesOpen} class="flex w-full items-center justify-between border-l-4 border-[var(--color-primary-500)]/50 bg-[var(--color-surface-base)] px-2.5 py-1.5 transition-colors hover:bg-[var(--color-surface-overlay)]">
				<span class="text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--color-surface-text)]">Language</span>
				<div class="flex items-center space-x-2">
					<span class="rounded bg-[var(--color-surface-overlay)] px-1.5 py-0.5 text-[11px] text-[var(--color-surface-text-muted)]">{languages.length}</span>
					<svg class="h-3.5 w-3.5 text-[var(--color-surface-text-muted)] transition-transform {languagesOpen ? 'rotate-180' : ''}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
					</svg>
				</div>
			</button>
			{#if languagesOpen}
				<div class="border-b border-[var(--color-surface-border)] p-1.5">
					<input type="search" bind:value={languageSearch} placeholder="Search languages" class="h-7 w-full rounded-md border border-[var(--color-surface-border)] bg-[var(--color-surface-overlay)] px-2 text-xs text-[var(--color-surface-text)] placeholder:text-[var(--color-surface-text-muted)] focus:border-[var(--color-primary-500)] focus:outline-none" />
				</div>
				<div class="max-h-48 overflow-y-auto">
					...
					{#if languages.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No languages found</p>
					{:else if visibleLanguages.length === 0}
						<p class="px-2.5 py-1.5 text-xs text-[var(--color-surface-text-muted)]">No matching languages</p>
					{/if}
				</div>
			{/if}
		</div>
