...
>
	...
	{/if}
	{#if error}
		<div class="initial-loading-overlay" aria-live="polite">
			<div class="initial-loading-content">
	...
	<header class="top-nav" class:top-nav-hidden={!topBarVisible}>
		...
		<div class="nav-right">
			...
			<button onclick={toggleFullscreen} class="nav-btn fullscreen-btn mobile-secondary" title="Fullscreen">
				<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<style>
	...
	@media (max-width: 768px) {
		...
		.fullscreen-btn.mobile-secondary {
			display: flex;
		}
