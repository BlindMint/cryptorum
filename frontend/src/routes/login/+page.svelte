...
{#if checked}
<div class="h-[100dvh] overflow-hidden overscroll-none bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4 py-4 sm:py-8">
	<div class="w-full max-w-md min-h-0">
